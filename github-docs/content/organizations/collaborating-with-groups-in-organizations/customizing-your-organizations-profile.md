...
1. In the "Edit pinned repositories" dialog box, select a combination of up to six public, private, or internal repositories to display.
1. Click **Save pins**.
