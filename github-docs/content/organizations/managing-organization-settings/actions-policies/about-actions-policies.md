...
To configure workflow execution protections for your organization, including setting up event and actor rules, see [Workflow Execution Protections](https://docs.github.com/en/organizations/managing-organization-settings/actions-policies/workflow-execution-protections).
