...
To use the examples in the guide, you will need a repository on GitHub.com. macOS runners are not available on subdomains of GHE.com, such as `octocorp.ghe.com`.
