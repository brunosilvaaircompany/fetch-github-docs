...
Before starting this guide, you should be generating artifact attestations for your builds. See [Use Artifact Attestations](https://docs.github.com/en/actions/how-tos/secure-your-work/use-artifact-attestations/use-artifact-attestations).
