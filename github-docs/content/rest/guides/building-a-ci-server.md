...
in a GitHub pull request. For more information about the relevant endpoints, see [Statuses](https://docs.github.com/en/rest/commits/statuses).
...
> [!NOTE]
> Alternatively, you can use webhook forwarding to set up your local environment to receive webhooks. For more information, see [Using The GitHub CLI To Forward Webhooks For Testing](https://docs.github.com/en/webhooks/testing-and-troubleshooting-webhooks/using-the-github-cli-to-forward-webhooks-for-testing).
...
[a personal access token](/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens):
