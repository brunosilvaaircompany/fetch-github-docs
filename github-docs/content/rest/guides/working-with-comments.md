...
[Octokit.rb](https://github.com/octokit/octokit.rb). You'll also want to create a [personal access token](/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens).
