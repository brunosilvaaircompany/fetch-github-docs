...
You can use the REST API to subscribe to notifications for activity in a repository. To bookmark a repository instead, see [Starring](https://docs.github.com/en/rest/activity/starring).
...
this data. You should now use the "star" endpoints instead. For more information, [Starring](https://docs.github.com/en/rest/activity/starring) and the [changelog post](https://developer.github.com/changes/2012-09-05-watcher-api/).
