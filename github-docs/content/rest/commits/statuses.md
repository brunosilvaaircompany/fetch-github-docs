...
If you are developing a GitHub App  and want to provide more detailed information about an external service, you may want to use the REST API to manage checks. For more information, see [Checks](https://docs.github.com/en/rest/checks).
