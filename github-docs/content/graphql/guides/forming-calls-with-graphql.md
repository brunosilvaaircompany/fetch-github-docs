...
To authenticate with a personal access token, follow the steps in [Managing Your Personal Access Tokens](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens). The data that you are requesting will dictate which scopes or permissions you will need.
...
If you access GitHub at a different domain, such as `octocorp.ghe.com`, the endpoint will reflect that domain. For example: `https://api.octocorp.ghe.com/graphql`.
...
For information about rate limiting, see [Rate Limits And Query Limits For The GraphQL API](https://docs.github.com/en/graphql/overview/rate-limits-and-query-limits-for-the-graphql-api).
