...
To upgrade your account's plan, see [Upgrade Plan](https://docs.github.com/en/billing/how-tos/manage-plan-and-licenses/upgrade-plan).

## How can I downgrade my plan?

To downgrade your personal account or organization's plan, see [Downgrade Plan](https://docs.github.com/en/billing/how-tos/manage-plan-and-licenses/downgrade-plan).
...
For details on the differences for each GitHub Free product, see [Githubs Plans](https://docs.github.com/en/get-started/learning-about-github/githubs-plans).

## How can I get more Actions minutes if I need more than allocated in the GitHub Team plan?

Most small teams use fewer than 3,000 Actions minutes/month, but some teams might use more. If your team needs additional minutes for private repositories, you can increase your spending limit for GitHub Actions. Actions minutes and Packages storage are still free for your public repositories. For more information, see [Set Up Budgets](https://docs.github.com/en/billing/how-tos/set-up-budgets).

## How do the seat limit changes affect me?

Now that GitHub Team has no minimum seat requirement, if you are using fewer than five seats in your organization, you can remove paid seats to reduce your bill. For more information, see [Downgrade Plan](https://docs.github.com/en/billing/how-tos/manage-plan-and-licenses/downgrade-plan).
