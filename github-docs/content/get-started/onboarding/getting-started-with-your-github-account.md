...
For more information on all of GitHub's plans, see [Githubs Plans](https://docs.github.com/en/get-started/learning-about-github/githubs-plans).

### 3. Verifying your email address

To ensure you can use all the features in your GitHub plan, verify your email address after signing up for a new account. For more information, see [Verifying Your Email Address](https://docs.github.com/en/account-and-profile/how-tos/email-preferences/verifying-your-email-address).
...
Once you install Git, you can connect to GitHub repositories from your local computer, whether your own repository or another user's fork. When you connect to a repository on your GitHub Enterprise Server instance from Git, you'll need to authenticate with GitHub using either HTTPS or SSH. For more information, see [About Remote Repositories](https://docs.github.com/en/get-started/git-basics/about-remote-repositories).
...
As the owner of a repository you can configure several settings, including the repository's visibility, topics, and social media preview. For more information, see [Managing Your Repositorys Settings And Features](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features).
...
You can use GitHub Pages to create and host a website directly from a repository on your GitHub Enterprise Server instance. For more information, see [What Is GitHub Pages](https://docs.github.com/en/pages/getting-started-with-github-pages/what-is-github-pages).
...
For more information, see [Secure Your Supply Chain](https://docs.github.com/en/code-security/how-tos/secure-your-supply-chain).
...
You can read documentation that reflects the GitHub product you're currently using. For more information, see [About Versions Of GitHub Docs](https://docs.github.com/en/get-started/using-github-docs/about-versions-of-github-docs).
