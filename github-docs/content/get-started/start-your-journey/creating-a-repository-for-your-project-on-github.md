...
1. In the upper-right corner of any page on GitHub, select {% octicon "plus" aria-label="Create new" %}, then click **New repository**.
...
* Now that your software project has a home, plan the work you want to do. Continue to [Planning Your Work](https://docs.github.com/en/get-started/start-your-journey/planning-your-work).
