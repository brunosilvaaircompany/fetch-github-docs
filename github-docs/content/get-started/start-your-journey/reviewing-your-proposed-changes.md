...
* An open pull request for your `add-starred-list` branch. If you haven't opened one yet, see [Writing And Storing Your Code](https://docs.github.com/en/get-started/start-your-journey/writing-and-storing-your-code).
...
1. In GitHub Desktop, enter a commit message such as `Address review feedback`, then click **Commit # files to add-starred-list**.
...
* Publish your software project to a live URL that updates your website automatically. Continue to [Deploying Your Website Automatically](https://docs.github.com/en/get-started/start-your-journey/deploying-your-website-automatically).
