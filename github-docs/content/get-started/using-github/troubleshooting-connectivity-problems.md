...
Make sure your network is configured to allow GitHub's IP addresses. For more information, see [About Githubs Ip Addresses](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/about-githubs-ip-addresses).
...
You can also try creating an account with an alternate email address or with a social login (including Google). Once your account is successfully created, you can update the email address associated with your account to your preferred email in your [Emails](https://github.com/settings/emails) settings page. See [Email Preferences](https://docs.github.com/en/account-and-profile/how-tos/email-preferences).
