...
1. Open GitHub Desktop, then click **Sign in to GitHub.com** and authorize GitHub Desktop to access your account.
1. Back in GitHub Desktop, click **Finish**. This will add your name and email from your GitHub account to Git.
...
1. To see your remote repository, click **View on GitHub**.
...
1. In GitHub Desktop, select the {% octicon "git-branch" aria-hidden="true" aria-label="git-branch" %} **Current Branch** dropdown menu, then click **New Branch**.
...
1. In VS Code, paste the following text into `README.md` and save your changes:
...
1. Back in GitHub Desktop, you'll see the updates you just made to your README. In the bottom left, next to your GitHub profile picture, type "Update README" in the text box. This is called a **commit message**, and it helps you keep track of the changes you make in each commit.
...
1. In the GitHub window that appears, change your pull request title to "Add a message to the README", then write a brief description of your changes in the comment box.
1. Click **Create pull request**.
...
1. In GitHub Desktop, if you aren't on the `main` branch, select the {% octicon "git-branch" aria-hidden="true" aria-label="git-branch" %} **Current Branch** dropdown menu, then click **main**.
...
1. [Install the GitHub CLI](https://github.com/cli/cli?tab=readme-ov-file#installation), which lets you perform GitHub-related actions quickly from the command line.
1. To authenticate to GitHub from the GitHub CLI, run the following command:
...
1. Install GitHub Copilot CLI, so that you can use Copilot from the command line. See [Install Copilot CLI](https://docs.github.com/en/copilot/how-tos/copilot-cli/set-up-copilot-cli/install-copilot-cli).
