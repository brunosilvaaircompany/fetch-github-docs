...
Then, in the menu bar at the top of the file, click {% octicon "copilot" aria-label="Ask Copilot about this file" %} to start a conversation with Copilot.
...
Turn Dependabot alerts on for your repository now. Click the **{% octicon "shield" aria-hidden="true" aria-label="shield" %} Security and quality** tab for your project's GitHub repository. Next to Dependabot alerts, click **Enable Dependabot alerts**. You can access Dependabot alerts from the **Dependabot** tab of the sidebar.
