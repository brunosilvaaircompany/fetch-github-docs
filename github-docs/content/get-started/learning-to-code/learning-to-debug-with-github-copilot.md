...
To understand what this error means, [open Copilot Chat in VS Code](vscode://GitHub.Copilot-Chat?ref_product=copilot&ref_type=engagement&ref_style=text), then paste and send the following prompt: 
...
To understand what went wrong, [open Copilot Chat](vscode://GitHub.Copilot-Chat?ref_product=copilot&ref_type=engagement&ref_style=text) and send the following prompt: 
...
As you continue coding, you'll likely encounter specific problem scenarios and errors that are difficult to debug. For a list of potential issues and example Copilot Chat prompts to fix them, see [Debug Errors](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/debug-errors).
