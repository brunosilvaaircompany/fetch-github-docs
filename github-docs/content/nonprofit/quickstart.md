...
1. From the "GitHub Organization" dropdown menu, select your nonprofit organization account. Then click **Continue**.
   ...
   > [!TIP]
   > If you are running into trouble finding your organization in the drop down, see [Cannot Find My Organization On GitHub For Nonprofits](https://docs.github.com/en/nonprofit/troubleshooting/cannot-find-my-organization-on-github-for-nonprofits).
