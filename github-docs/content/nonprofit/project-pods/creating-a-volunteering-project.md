...
* Your nonprofit is a verified member of **GitHub for Nonprofits**. If you haven't joined yet, see [Quickstart](https://docs.github.com/en/nonprofit/quickstart) to apply.
...
1. If you haven't joined yet, see [Quickstart](https://docs.github.com/en/nonprofit/quickstart) to apply.
