...
* _To create a new webhook with a secret token_, see [Creating Webhooks](https://docs.github.com/en/webhooks/using-webhooks/creating-webhooks).
* _To add a secret token to an existing webhook_, edit the webhook's settings. Under "Secret", type a string to use as a `secret` key. For more information, see [Editing Webhooks](https://docs.github.com/en/webhooks/using-webhooks/editing-webhooks).
