...
For more information about authorizing apps with SSO, see [Authorizing OAUTH Apps](https://docs.github.com/en/apps/oauth-apps/using-oauth-apps/authorizing-oauth-apps) or [Saml And GitHub Apps](https://docs.github.com/en/apps/using-github-apps/saml-and-github-apps).
