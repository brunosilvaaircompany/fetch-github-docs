...
See [About GitHub Models](https://docs.github.com/en/github-models/about-github-models).
...
Once you have decided which models you want to use, you can limit access in your organization to only those models, see [Manage Models At Scale](https://docs.github.com/en/github-models/github-models-at-scale/manage-models-at-scale).
...
1. **Call your prompt in a workflow**
   ...
   For information on creating workflows, see [Write Workflows](https://docs.github.com/en/actions/how-tos/write-workflows).
