...
For full details on available fields, headers, and request formats, see the [API reference for GitHub Models](/free-pro-team@latest/rest/models/inference?apiVersion=2022-11-28).
