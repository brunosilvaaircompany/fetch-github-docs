...
> * Usage is rate limited. See [Prototyping With Ai Models](https://docs.github.com/en/github-models/use-github-models/prototyping-with-ai-models#rate-limits).
...
To learn more about the pre-built evaluators like similarity, groundedness, and relevance, see [Evaluating Ai Models](https://docs.github.com/en/github-models/use-github-models/evaluating-ai-models#evaluating-outputs).
