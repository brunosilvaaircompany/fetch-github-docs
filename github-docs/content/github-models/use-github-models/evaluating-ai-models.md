...
To familiarize yourself with how to create and manage prompts in GitHub Models, see [Testing a prompt in the Playground](/github-models/use-github-models/optimizing-your-ai-powered-app-with-github-models).
...
Alternatively, you can add variables in your `.prompt.yml` file system or user prompt to automate the process of evaluating with multiple variables in the future. See [Storing Prompts In GitHub Repositories](https://docs.github.com/en/github-models/use-github-models/storing-prompts-in-github-repositories).
