...
1. To use GitHub CLI, you'll need to install it first. See [Quickstart](https://docs.github.com/en/github-cli/github-cli/quickstart).
...
* Edit a file directly on GitHub by browsing to it and clicking {% octicon "pencil" aria-label="Edit this file" %}.
...
After your first pull request, try reviewing someone else's work. See [Reviewing Pull Requests Quickstart](https://docs.github.com/en/pull-requests/get-started/reviewing-pull-requests-quickstart).
