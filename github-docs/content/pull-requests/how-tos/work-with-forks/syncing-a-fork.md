...
Before you can sync your fork with an upstream repository, you must configure a remote that points to the upstream repository in Git. See [Configuring A Remote Repository For A Fork](https://docs.github.com/en/pull-requests/how-tos/work-with-forks/configuring-a-remote-repository-for-a-fork).
...
1. Merge the changes from the upstream default branch into your local default branch. In this example, the upstream default branch is `upstream/main`. This syncs your fork's default branch with the upstream repository without losing your local changes.
   ...
   If your local branch had unique commits, you may need to resolve conflicts. See [Merge And Close Pull Requests](https://docs.github.com/en/pull-requests/how-tos/merge-and-close-pull-requests).

> [!TIP]
> Syncing your fork only updates your local copy of the repository. To update your fork on your GitHub Enterprise Server instance, you must [push your changes](/get-started/using-git/pushing-commits-to-a-remote-repository).
