...
For the full set of metadata fields and patterns to reduce redundant CI usage, see [Optimizing Ci For Stacked Pull Requests](https://docs.github.com/en/pull-requests/how-tos/merge-and-close-pull-requests/optimizing-ci-for-stacked-pull-requests).
...
For instructions, see [Managing Stacked Pull Requests](https://docs.github.com/en/pull-requests/how-tos/create-pull-requests/managing-stacked-pull-requests#rebasing-your-stack).

## Further reading

* [Roll Out Stacked Prs](https://docs.github.com/en/pull-requests/tutorials/roll-out-stacked-prs)
