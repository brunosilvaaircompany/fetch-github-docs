...
To get started with GitHub Importer, see [Importing A Repository With GitHub Importer](https://docs.github.com/en/migrations/importing-source-code/using-github-importer/importing-a-repository-with-github-importer#importing-a-repository-with-github-importer).
...
* Repositories and individual files on GitHub are subject to size limits. For more information, see [About Large Files On GitHub](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github).
