...
1. In the "GitHub Enterprise Server" application settings, click **Single sign-on** in the left sidebar, then click **SAML**.
...
1. In the "Set up GitHub Enterprise Server" section, make a note of the Login URL and Microsoft Entra Identifier.
