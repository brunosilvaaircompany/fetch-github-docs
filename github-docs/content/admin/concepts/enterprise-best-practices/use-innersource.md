...
For more information, see [About Repositories](https://docs.github.com/en/repositories/creating-and-managing-repositories/about-repositories#about-internal-repositories) and [Setting Base Permissions For An Organization](https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/setting-base-permissions-for-an-organization).
...
* [About Readmes](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-readmes), [Customizing Your Organizations Profile](https://docs.github.com/en/organizations/collaborating-with-groups-in-organizations/customizing-your-organizations-profile#adding-a-member-only-organization-profile-readme), and [Creating A Readme For An Enterprise](https://docs.github.com/en/admin/managing-your-enterprise-account/creating-a-readme-for-an-enterprise)
...
* Use **discussions** to make their work more visible to other teams. See [Participating In A Discussion](https://docs.github.com/en/discussions/collaborating-with-your-community-using-discussions/participating-in-a-discussion#creating-a-discussion).
* Create a dedicated internal repository for sharing **actions and reusable GitHub Actions workflows**, which anyone can reference when they write a workflow within the enterprise. See [Share With Your Enterprise](https://docs.github.com/en/actions/how-tos/reuse-automations/share-with-your-enterprise).
* Share reusable pieces of code in internal packages with **GitHub Packages** registries. For enhanced security, you can give GitHub's security features access to these registries. See [Introduction To GitHub Packages](https://docs.github.com/en/packages/learn-github-packages/introduction-to-github-packages).
* Set up common templates and frameworks as **template repositories** that other people can copy to get started with a project. See [Creating A Template Repository](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-template-repository).
...
For more information, see [Enabling Guest Collaborators](https://docs.github.com/en/admin/managing-accounts-and-repositories/managing-users-in-your-enterprise/enabling-guest-collaborators) and [Adding Outside Collaborators To Repositories In Your Organization](https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-outside-collaborators/adding-outside-collaborators-to-repositories-in-your-organization).

## Next steps

Now that you've set up organizations and teams, learn how to stay compliant and secure by setting up governance policies for your users and repositories. See [Enterprise Policies](https://docs.github.com/en/admin/concepts/security-and-compliance/enterprise-policies).
