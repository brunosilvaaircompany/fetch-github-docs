...
For instructions, see [Removing A Member From Your Enterprise](https://docs.github.com/en/admin/managing-accounts-and-repositories/managing-users-in-your-enterprise/removing-a-member-from-your-enterprise).
...
For Enterprise Managed Users, you will find a more exhaustive list of effects of offboarding in [Deprovisioning And Reinstating Users](https://docs.github.com/en/admin/managing-iam/provisioning-user-accounts-with-scim/deprovisioning-and-reinstating-users).
...
* Your enterprise has **disabled** the policy described in [Control Offboarding](https://docs.github.com/en/admin/enforcing-policies/enforcing-policies-for-your-enterprise/control-offboarding).
