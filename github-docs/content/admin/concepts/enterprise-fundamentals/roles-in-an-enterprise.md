...
Now that you understand roles, plan which roles will be required for your teams to do their jobs on GitHub. See [Identify Role Requirements](https://docs.github.com/en/admin/managing-accounts-and-repositories/managing-roles-in-your-enterprise/identify-role-requirements).
