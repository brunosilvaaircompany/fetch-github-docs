...
If GitHub Actions is enabled, the service backs up the MS SQL Server database using a tiered cadence:
...
Backup timing is controlled by the `MSSQL Backup Cadence` setting in the Management Console. Over time, a snapshot includes:
