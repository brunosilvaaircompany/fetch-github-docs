...
Roles control people's access to settings and resources in your enterprise and organizations. For an introduction to roles, see [Roles In An Enterprise](https://docs.github.com/en/admin/concepts/enterprise-fundamentals/roles-in-an-enterprise).
...
| --------- | ---------------- |
| Predefined enterprise roles | [Abilities Of Roles](https://docs.github.com/en/admin/managing-accounts-and-repositories/managing-roles-in-your-enterprise/abilities-of-roles) |
| Predefined organization roles | [Roles In An Organization](https://docs.github.com/en/organizations/managing-peoples-access-to-your-organization-with-roles/roles-in-an-organization) |
...
| Custom organization roles | [Permissions Of Custom Organization Roles](https://docs.github.com/en/organizations/managing-peoples-access-to-your-organization-with-roles/permissions-of-custom-organization-roles) |
...
For more information about what apps can do, see [About Creating GitHub Apps](https://docs.github.com/en/apps/creating-github-apps/about-creating-github-apps/about-creating-github-apps#understanding-what-type-of-github-app-to-build).
