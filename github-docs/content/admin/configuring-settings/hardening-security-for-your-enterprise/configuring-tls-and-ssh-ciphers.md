...
1. Review the instance logs for TLS handshake failures or SSH connection errors. For more information about accessing logs, see [About System Logs](https://docs.github.com/en/admin/monitoring-and-managing-your-instance/monitoring-your-instance/about-system-logs).
...
1. If the issue persists after restoring defaults, contact [GitHub Enterprise Support](https://support.github.com).
