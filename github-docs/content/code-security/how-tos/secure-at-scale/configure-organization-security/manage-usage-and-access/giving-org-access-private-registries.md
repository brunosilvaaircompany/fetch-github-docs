...
For languages supporting private package registries, code scanning default setup will produce information on the tool status page. This shows you which private registry configurations were available to an analysis, but not whether code scanning default setup was able to successfully download private dependencies from them. For more information about the tool status page, see [Use The Tools Status Page For Code Scanning](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/manage-your-configuration/use-the-tools-status-page-for-code-scanning).

Alternatively, you can confirm whether private registries were used successfully by code scanning analysis by looking in the Actions log files, see [Code Scanning Logs](https://docs.github.com/en/code-security/reference/code-scanning/code-scanning-logs#diagnostic-information-for-private-package-registries).
