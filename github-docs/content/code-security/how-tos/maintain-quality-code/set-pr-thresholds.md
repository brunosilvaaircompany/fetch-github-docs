...
* Code Quality is enabled. See [Enable Code Quality?Utm_Campaign=Code Quality Ga July 2026&Utm_Medium=Docs&Utm_Source=Docs Set Quality Thresholds Enable Cq](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/enable-code-quality?utm_campaign=code-quality-ga-july-2026&utm_medium=docs&utm_source=docs-set-quality-thresholds-enable-cq)
...
> [!NOTE]
> The threshold will have an impact only if the repository has code in one or more of the supported languages, see [Enable Code Quality](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/enable-code-quality).
...
1. Confirm that the "CodeQL - Code Quality" check ran successfully and reported its status.

For more information, see [Codeql Detection](https://docs.github.com/en/code-security/reference/code-quality/codeql-detection).
...
You can also block pull requests that fall below a code coverage threshold. This uses a separate **Restrict code coverage** rule, not the **Require code quality results** rule used above, and your repository must upload code coverage data first. For the full procedure, see [Restrict Code Coverage](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/restrict-code-coverage).

## Next steps

Learn how GitHub Code Quality works on pull requests to prevent code quality issues from reaching your default branch. See [Catch Issues Before Merge](https://docs.github.com/en/code-security/tutorials/improve-code-quality/catch-issues-before-merge).
