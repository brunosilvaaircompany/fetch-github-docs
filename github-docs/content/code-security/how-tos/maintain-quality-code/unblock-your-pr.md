...
1. Fix or dismiss the relevant findings. For detailed instructions, see [Fix Pr Findings](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/fix-pr-findings).
...
1. Add or update tests to increase execution coverage. Copilot can help you write and update your tests. See [Testing Code](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/testing-code).
