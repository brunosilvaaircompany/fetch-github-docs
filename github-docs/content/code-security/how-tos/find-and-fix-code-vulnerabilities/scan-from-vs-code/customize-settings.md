...
## About settings in the CodeQL for Visual Studio Code extension
...
## Editing settings for the CodeQL extension
...
There are a number of settings under "Variant Analysis" that you can use to define or edit lists of GitHub repositories for variant analysis, and change to a different controller repository. For information on the purpose and requirements for a controller repository, see [Run Queries At Scale](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/run-queries-at-scale).
...
This setting is disabled by default. You may want to enable the setting if you regularly browse the source code of databases (for example, to view the abstract syntax tree of the code). For more information, see [Explore Code Structure](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/explore-code-structure).
...
To pass additional arguments to the CodeQL CLI when running tests, you can update the "Running Tests: Additional Test Arguments" setting. For more information about the available arguments, see [Test Run](https://docs.github.com/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/test-run).

### Configuring settings for telemetry and data collection

You can configure whether the CodeQL extension collects telemetry data. This is disabled by default. For more information, see [Telemetry In Codeql For Visual Studio Code](https://docs.github.com/en/code-security/reference/code-scanning/codeql/codeql-for-vs-code/telemetry-in-codeql-for-visual-studio-code).



## Changing the GitHub URL used by the extension

By default, the CodeQL for Visual Studio Code extension is configured to analyze repositories hosted on GitHub.com. If you use GitHub Enterprise Cloud with data residency, you can specify the URL of your site using the "GitHub Enterprise URI" setting.

### Specifying the GitHub URL in your settings

1. Open the "Extensions" view and right-click **CodeQL**, then click **Extension Settings**.

1. In the "Settings" window, scroll down until you find the GitHub Authentication settings and enter the URL of your GitHub Enterprise Cloud with data residency. The new settings are saved automatically.

   ![Screenshot of the "Extensions" settings for "GitHub Authentication" the URI field is outlined in dark orange.](/assets/images/help/security/codeql-for-vs-code-set-ghe-uri.png)
...
When GitHub Enterprise URI (`github-enterprise.uri`) is defined, the extension uses this URL in:

* Requests to download databases from GitHub
* Creating a list of repositories for variant analysis

> [!NOTE]
> GitHub Enterprise Cloud with data residency requires authentication to see all repositories, so you will need to authenticate before you can download or analyze data. In addition, you will not see any "Top XX repositories" lists for variant analysis, see [Run Queries At Scale](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/run-queries-at-scale).
