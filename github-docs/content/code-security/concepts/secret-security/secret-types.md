...
For information on the usage, scope, permissions, and limitations of each secret type, see [Secret Types](https://docs.github.com/en/code-security/reference/secret-security/secret-types).
