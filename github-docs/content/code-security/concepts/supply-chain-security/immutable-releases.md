...
To learn how to enable immutable releases for your repository or organization, see [Prevent Release Changes](https://docs.github.com/en/code-security/how-tos/secure-your-supply-chain/establish-provenance-and-integrity/prevent-release-changes).

To learn how to ensure a release and local assets have not been changed, see [Verify Release Integrity](https://docs.github.com/en/code-security/how-tos/secure-your-supply-chain/secure-your-dependencies/verify-release-integrity).
