...
1. Dependabot checks for updates according to the group's schedule.
...
For a complete reference of all available configuration options and their behavior, see [Dependabot Options Reference](https://docs.github.com/en/code-security/reference/supply-chain-security/dependabot-options-reference#multi-ecosystem-groups-).
...
* [Configuring Multi Ecosystem Updates](https://docs.github.com/en/code-security/how-tos/secure-your-supply-chain/secure-your-dependencies/configuring-multi-ecosystem-updates)
