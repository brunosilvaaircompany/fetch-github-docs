...
You can create query suites for the queries that you want to frequently use in your CodeQL analyses. For more information, see [Codeql Query Suites](https://docs.github.com/en/code-security/concepts/code-scanning/codeql/codeql-query-suites).

> [!NOTE]
> Any custom queries that you want to add to a query suite must be in a [CodeQL pack](/code-security/tutorials/customize-code-scanning/customize-analysis) and contain the correct query metadata. For more information, see [Write Custom Queries](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/write-custom-queries).
...
> [!NOTE]
> You can use the `codeql resolve queries /path/to/suite.qls` command to see which queries are selected by a query suite definition. For more information, see [Resolve Queries](https://docs.github.com/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/resolve-queries).
...
pack. For more information, see [Customize Analysis](https://docs.github.com/en/code-security/tutorials/customize-code-scanning/customize-analysis).
...
[Analyze Code](https://docs.github.com/en/code-security/tutorials/customize-code-scanning/analyze-code).
