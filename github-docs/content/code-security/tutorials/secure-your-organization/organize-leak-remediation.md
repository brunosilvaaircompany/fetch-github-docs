...
* You must have both GitHub Secret Protection and secret scanning enabled for your organization. See [Protect Your Secrets](https://docs.github.com/en/code-security/how-tos/secure-at-scale/configure-organization-security/configure-specific-tools/protect-your-secrets).
...
1. In the left sidebar, under "Findings", click the {% octicon "chevron-down" aria-hidden="true" aria-label="chevron-down" %} symbol to the right of **Secret scanning**.
...
1. Optionally, in the sidebar under "Insights," click **Secret scanning** to see:
...
1. Navigate to your organization and click **{% octicon "shield" aria-hidden="true" aria-label="shield" %} Security and quality**.
