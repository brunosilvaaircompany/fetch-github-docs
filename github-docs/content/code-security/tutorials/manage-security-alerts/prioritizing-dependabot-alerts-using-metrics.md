...
For more information about these metrics, see [Dependabot Alert Metrics](https://docs.github.com/en/code-security/concepts/supply-chain-security/dependabot-alert-metrics).

Additionally, you can specify complex filters, which are combinations of the individual filters that are available. For more information about filters, see [Dependabot dashboard view filters](/code-security/reference/security-at-scale/overview-dashboard-filters#dependabot-dashboard-filters).
...
You can customize the default funnel order on the "Alert prioritization" graph to ensure it reflects the unique risk profile, business priorities, and compliance requirements of your organization. See [Viewing Metrics For Dependabot Alerts](https://docs.github.com/en/code-security/how-tos/view-and-interpret-data/analyze-organization-data/viewing-metrics-for-dependabot-alerts#configuring-funnel-categories).
