...
For information about features in GitHub that can help you secure dependencies, see [Supply Chain Security](https://docs.github.com/en/code-security/concepts/supply-chain-security/supply-chain-security).
