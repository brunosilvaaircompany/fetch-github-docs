...
The extractor didn’t find any code to analyze when running [Database Create](https://docs.github.com/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-create) or [Database Finalize](https://docs.github.com/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-finalize).
