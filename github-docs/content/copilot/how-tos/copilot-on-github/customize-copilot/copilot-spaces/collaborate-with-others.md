...
1. In the top right corner of the space, click **{% octicon "share" aria-hidden="true" aria-label="share" %}**.
1. To add specific GitHub users, search for them with the search bar, then choose a role for the people you added.
...
You can also use organization spaces directly in your IDE by specifying the organization as the owner when accessing the space. For more information, see [Use Copilot Spaces](https://docs.github.com/en/copilot/how-tos/provide-context/use-copilot-spaces/use-copilot-spaces#using-copilot-spaces-in-your-ide).
