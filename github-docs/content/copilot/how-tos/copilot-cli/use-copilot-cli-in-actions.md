...
For background on authentication options and how billing works when running Copilot CLI in GitHub Actions, see [Copilot CLI In GitHub Actions](https://docs.github.com/en/copilot/concepts/agents/copilot-cli/copilot-cli-in-github-actions).
...
1. Navigate to the policy settings for your organization. See [Manage Policies](https://docs.github.com/en/copilot/how-tos/administer-copilot/manage-for-organization/manage-policies).
1. Under "Copilot CLI", confirm that **Allow use of Copilot CLI billed to the organization** is selected.
