...
You can use the same set of search qualifiers that are available on GitHub.com. See [Searching Issues And Pull Requests](https://docs.github.com/en/search-github/searching-on-github/searching-issues-and-pull-requests).
