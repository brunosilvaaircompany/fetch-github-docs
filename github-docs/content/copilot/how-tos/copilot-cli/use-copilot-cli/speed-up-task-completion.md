...
For more information, see [Fleet](https://docs.github.com/en/copilot/concepts/agents/copilot-cli/fleet).
...
1. Work with Copilot in plan mode to create an implementation plan.
