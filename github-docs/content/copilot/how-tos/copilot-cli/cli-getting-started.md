...
1. In the CLI interface, enter `/login` and follow the on-screen prompts to authenticate with your GitHub account.
...
1. Try asking Copilot a question, for example:

   ```copilot copy
   Give me an overview of this project.
   ```

   If you like, you can speak your prompt instead of typing it. See [Voice Input](https://docs.github.com/en/copilot/how-tos/copilot-cli/use-copilot-cli/voice-input).
