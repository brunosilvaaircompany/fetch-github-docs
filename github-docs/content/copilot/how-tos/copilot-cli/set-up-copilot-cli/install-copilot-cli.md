...
1. Under **Resource owner**, select your **personal account**. Do not select an organization. The **Copilot Requests** permission is only available on user-owned fine-grained personal access tokens.
...
1. Click **Add permissions** and select **Copilot Requests**.
...
You can now use Copilot from the command line. See [Overview](https://docs.github.com/en/copilot/how-tos/copilot-cli/use-copilot-cli/overview).

For a list of commands for Copilot CLI, including the command to update, see [CLI Command Reference](https://docs.github.com/en/copilot/reference/copilot-cli-reference/cli-command-reference).
