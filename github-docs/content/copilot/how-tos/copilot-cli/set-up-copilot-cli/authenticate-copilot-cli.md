...
If you run into authentication problems, see [Troubleshoot Copilot CLI Auth](https://docs.github.com/en/copilot/how-tos/copilot-cli/set-up-copilot-cli/troubleshoot-copilot-cli-auth).
