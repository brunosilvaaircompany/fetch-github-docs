...
These image blocks appear in `tool.execution_complete` event results. See the [Streaming Events](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/streaming-events) guide for the full event lifecycle.
...
* [Streaming Events](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/streaming-events): event lifecycle including tool result content blocks
* [Steering And Queueing](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/steering-and-queueing): sending follow-up messages with attachments
