...
* [Streaming Events](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/streaming-events): Full field-level reference for every event type
* [Session Persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence): How sessions are saved and resumed
* [Hooks](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/hooks): Intercepting events in the loop (permissions, tools)
