...
> [!NOTE]
> Thresholds are context utilization ratios (0.0-1.0), not absolute token counts. See the [Compatibility](https://docs.github.com/en/copilot/how-tos/copilot-sdk/troubleshooting/compatibility) for details.
...
* [Hooks Overview](https://docs.github.com/en/copilot/how-tos/copilot-sdk/hooks/hooks-overview) - Customize session behavior with hooks
* [Compatibility](https://docs.github.com/en/copilot/how-tos/copilot-sdk/troubleshooting/compatibility) - SDK vs CLI feature comparison
* [Debugging](https://docs.github.com/en/copilot/how-tos/copilot-sdk/troubleshooting/debugging) - Troubleshoot session issues
