...
Plugin agents are first-class sub-agents in [Fleet Mode](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/fleet-mode): a parent agent can dispatch them by `agent_type`, and the runtime fires the `subagentStart` / `subagentStop` hooks for them like any other sub-agent.
...
* [Custom Agents](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/custom-agents): write agents that ship inside a plugin's `agents/` folder.
* [Skills](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/skills): how `SKILL.md` files are loaded, and the skill-tier ordering rules.
* [Hooks](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/hooks): hooks defined by a plugin fire alongside SDK-registered hooks.
* [MCP](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/mcp): plugin-provided MCP servers integrate the same way as inline registrations.
* [Fleet Mode](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/fleet-mode): plugin-provided agents are dispatchable as sub-agents.
