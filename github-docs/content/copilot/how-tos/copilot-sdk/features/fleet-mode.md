...
For hook configuration that is already exposed at the SDK layer, see [Hooks](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/hooks). For sub-agent event payloads, see [Custom Agents](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/custom-agents).
