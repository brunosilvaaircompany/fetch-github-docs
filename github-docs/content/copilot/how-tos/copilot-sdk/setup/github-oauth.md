...
For a lighter resource footprint, you can run a single external CLI server and pass tokens per session. See [Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services) for this pattern.
...
| Need | Next Guide |
|------|-----------|
| Users without GitHub accounts | [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) |
| Run the SDK on servers | [Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services) |
| Handle many concurrent users | [Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling) |

## Next steps

* **[Authenticate](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/authenticate)**: Full auth method reference
* **[Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**: Run the SDK server-side
* **[Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**: Handle many users at scale
