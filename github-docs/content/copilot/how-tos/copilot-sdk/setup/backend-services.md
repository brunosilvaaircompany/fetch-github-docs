...
For multi-user server mode, configure SDK clients with `mode: "empty"`, pass user credentials per session, and explicitly allow tools for each session. See [Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) for the full pattern.
...
Pass individual user tokens when creating sessions. See [GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) for the full flow.
...
Use your own API keys for the model provider. See [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) for details.
...
| Limitation | Details |
|------------|---------|
| **Single CLI server = single point of failure** | See [Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling) for HA patterns |
...
| Need | Next Guide |
|------|-----------|
| Multiple CLI servers / high availability | [Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling) |
| SDK isolation for concurrent users | [Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) |
| GitHub account auth for users | [GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) |
| Your own model keys | [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) |

## Next steps

* **[Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**: Configure SDK isolation for concurrent users
* **[Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**: Handle more users, add redundancy
...
* **[GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**: Add user authentication
