...
| Non-Azure environment with static API key | Use [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) |
| GitHub Copilot subscription available | Use [GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) |

## See also

* [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok): Static API key configuration
* [Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services): Server-side deployment
