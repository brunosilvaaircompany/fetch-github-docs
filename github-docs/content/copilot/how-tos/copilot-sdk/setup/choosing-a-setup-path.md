...
**Start with:**
1. **[Bundled CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/bundled-cli)**—The SDK includes the CLI automatically—just install and go
1. **[Local CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/local-cli)**—Use your own CLI binary or running instance (advanced)
...
**Start with:**
1. **[GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**—Let employees sign in with their GitHub accounts
1. **[Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**—Run the SDK in your internal services

**If scaling beyond a single server:**
1. **[Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**—Configure SDK options for multi-user server mode
1. **[Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**—Handle multiple users and services
...
**Start with:**
1. **[GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**—Let customers sign in with GitHub
1. **[Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok)**—Manage identity yourself with your own model keys
1. **[Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**—Power your product from server-side code

**For production:**
1. **[Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**—Use `mode: "empty"`, per-session tokens, and isolated runtime state
1. **[Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**—Serve many customers reliably
...
**Start with:**
1. **[Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**—Core server-side integration
1. **[Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**—SDK-level isolation, per-session auth, and shared runtime options
1. **[Scaling](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**—Session isolation, horizontal scaling, persistence

**Depending on your auth model:**
1. **[GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**—For GitHub-authenticated users
1. **[Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok)**—For self-managed identity and model access
...
| What you need | Guide |
|---------------|-------|
| Getting started quickly | [Bundled CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/bundled-cli) |
| Use your own CLI binary or server | [Local CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/local-cli) |
| Users sign in with GitHub | [GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) |
