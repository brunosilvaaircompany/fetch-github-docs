...
For SDK-level options and patterns, see [Multi Tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy).
...
* **[Session Persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence)**: Deep dive on resumable sessions
* **[Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**: Core server-side setup
* **[GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**: Multi-user authentication
* **[Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok)**: Use your own model provider
