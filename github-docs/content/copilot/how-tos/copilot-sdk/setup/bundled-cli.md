...
> [!NOTE]
> The Go SDK does not bundle the CLI. You must install the CLI separately or set `Connection` to point to an existing binary. See [Local CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/local-cli) for details.
...
See the **[Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok)** for full details.
...
| Need | Next Guide |
|------|-----------|
| Users signing in with GitHub accounts | [GitHub OAUTH](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) |
| Run on a server instead of user machines | [Backend Services](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services) |
| Use your own model keys | [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) |
