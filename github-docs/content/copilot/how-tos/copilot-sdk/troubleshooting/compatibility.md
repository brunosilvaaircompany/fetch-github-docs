...
| Fleet mode | `session.rpc.fleet.start()` | Parallel sub-agent execution; see [Fleet Mode](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/fleet-mode) |
