...
* **GitHub Copilot CLI** installed and authenticated (the Node.js, Python, and .NET SDKs provide the CLI automatically—see [Bundled CLI](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/bundled-cli). Required for Go, Java, and Rust unless using their application-level CLI bundling features.)
...
📖 **[MCP](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/mcp)** - Learn about local vs remote servers, all configuration options, and troubleshooting.
...
> [!TIP]
> You can also set `agent: "pr-reviewer"` in the session config to pre-select this agent from the start. See the [Custom Agents](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/custom-agents#selecting-an-agent-at-session-creation) for details.
...
📖 **[Opentelemetry](https://docs.github.com/en/copilot/how-tos/copilot-sdk/observability/opentelemetry)**—TelemetryConfig options, trace context propagation, and per-language dependencies.

## Learn more

* [Authenticate](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/authenticate) - GitHub OAuth, environment variables, and BYOK
* [Byok](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) - Use your own API keys from Microsoft Foundry, OpenAI, etc.
...
* [MCP](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/mcp) - Integrate external tools via Model Context Protocol
* [GitHub MCP Server Documentation](https://github.com/github/github-mcp-server)
* [MCP Servers Directory](https://github.com/modelcontextprotocol/servers) - Explore more MCP servers
* [Opentelemetry](https://docs.github.com/en/copilot/how-tos/copilot-sdk/observability/opentelemetry) - TelemetryConfig, trace context propagation, and per-language dependencies
