...
|------|---------|----------|
| [Pre Tool Use](https://docs.github.com/en/copilot/how-tos/copilot-sdk/hooks/pre-tool-use) | Before a tool executes | Permission control, argument validation |
...
* **[Pre Tool Use](https://docs.github.com/en/copilot/how-tos/copilot-sdk/hooks/pre-tool-use)** - Control tool execution permissions
...
* [Getting Started](https://docs.github.com/en/copilot/how-tos/copilot-sdk/getting-started#step-4-add-a-custom-tool)
