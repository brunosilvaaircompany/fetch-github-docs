...
For a conceptual overview of sandboxing in Copilot CLI, see [About Cloud And Local Sandboxes](https://docs.github.com/en/copilot/concepts/about-cloud-and-local-sandboxes).
