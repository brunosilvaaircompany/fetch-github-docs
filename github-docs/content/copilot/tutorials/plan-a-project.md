...
Set up a repository with GitHub Issues enabled. See [Creating A New Repository](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-new-repository).
...
1. Using the chat panel, attach the repository for the shopping website. This allows Copilot to access the repository and create issues directly within it.
...
1. Review and decide whether to keep Copilot’s revised version, edit further, or prompt again for more detail. Copilot can add code snippets into the draft to improve clarity and provide immediate context for these issues.
...
Now that you’ve generated and refined your project issues, you can assign them to the right team members or even to Copilot itself for further assistance. To learn more about how to assign Copilot or contributors to issues, and how to continue planning and implementing your project with Copilot’s agentic features, see [Start Copilot Sessions](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/cloud-agent/start-copilot-sessions).
