...
For a full list of supported models and side-by-side feature comparisons, see [Model Comparison](https://docs.github.com/en/copilot/reference/ai-models/model-comparison).
...
For a complete walkthrough of the scenario, see [Write Tests](https://docs.github.com/en/copilot/tutorials/write-tests).
...
For a complete walkthrough of the scenario, see [Modernize Legacy Code](https://docs.github.com/en/copilot/tutorials/modernize-legacy-code).
