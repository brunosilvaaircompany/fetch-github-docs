...
* Use tools like [CodeQL](https://codeql.github.com/) and [Dependabot](/code-security/concepts/supply-chain-security/dependabot-version-updates) to catch vulnerabilities and dependency issues.
* Use GitHub Code Quality to catch reliability and maintainability issues and see code coverage. [About Code Quality](https://docs.github.com/en/code-security/concepts/about-code-quality).
* See [Generate Unit Tests](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/testing-code/generate-unit-tests) and [Create End To End Tests](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/testing-code/create-end-to-end-tests) for examples of verifying code with Copilot.
...
* Try [Synthesizing Research](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/communicate-effectively/synthesizing-research) to see how Copilot uses documentation and research to inform code generation.
...
In addition to automated tools like GitHub Code Quality, human standards still matter.
...
* Check [Improve Code Readability](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/refactor-code/improve-code-readability) for prompts and tips on reviewing and refactoring generated code.
...
* See [Debug Invalid Json](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/debug-errors/debug-invalid-json) as an example of catching subtle errors and debugging with Copilot.
...
* See [Communicate Effectively](https://docs.github.com/en/copilot/tutorials/copilot-cookbook/communicate-effectively) for examples of how to work with Copilot collaboratively and document findings.
...
* [Find Matching Code](https://docs.github.com/en/copilot/how-tos/get-code-suggestions/find-matching-code) shows how Copilot can help track down code patterns and automate search tasks.
...
* Reference [Copilot Cookbook](https://docs.github.com/en/copilot/tutorials/copilot-cookbook) for inspiration and share useful recipes in your team docs.
