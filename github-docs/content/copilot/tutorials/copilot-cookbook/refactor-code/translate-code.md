...
Translating a project containing multiple files is a more complex process, and is described in [Migrate A Project](https://docs.github.com/en/copilot/tutorials/migrate-a-project).
