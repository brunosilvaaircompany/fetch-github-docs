...
>[!TIP] You can include links to specific pull requests or issues in your prompts to give Copilot Chat more context. If you're not getting the results you expect, try specifying the repository in your prompt to help Copilot Chat focus on the right project.
