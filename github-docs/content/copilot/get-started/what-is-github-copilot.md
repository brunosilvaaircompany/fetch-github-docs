...
**For enterprises and organizations with data residency requirements:** If you use GitHub Enterprise Cloud, Copilot can enforce geographic data residency. See [GitHub Copilot With Data Residency](https://docs.github.com/en/admin/data-residency/github-copilot-with-data-residency).
...
See [Features](https://docs.github.com/en/copilot/get-started/features).
...
* **Get free access if you're eligible.** Students, teachers, and open source maintainers may qualify for access to premium features at no cost. See [Set Up For Students](https://docs.github.com/en/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-students) and [Set Up For Teachers And Os Maintainers](https://docs.github.com/en/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-teachers-and-os-maintainers).
...
See [Get Started With A Copilot Plan](https://docs.github.com/en/copilot/how-tos/manage-your-account/get-started-with-a-copilot-plan) for more information.
...
* Learn more about Copilot features. See [Features](https://docs.github.com/en/copilot/get-started/features).
