...
To view Copilot's supported models and their pricing, see [Models And Pricing](https://docs.github.com/en/copilot/reference/copilot-billing/models-and-pricing).
...
Included AI credits do not carry over between months. Unused credits are forfeited, and your allowance resets to the full monthly amount at 00:00:00 UTC on the first day of each calendar month. This reset date is fixed and does not change based on your subscription billing date. See [Billing Cycles](https://docs.github.com/en/billing/concepts/billing-cycles#billing-cycles-for-metered-products).
...
For guidance on how to optimize your usage and reduce spend, including how to set session limits to cap spend for agent tasks, see [Optimize Ai Usage](https://docs.github.com/en/copilot/tutorials/optimize-ai-usage).
...
To set up a budget for GitHub AI Credits, see [Set Up Budgets](https://docs.github.com/en/billing/how-tos/set-up-budgets#managing-budgets-for-your-personal-account).
...
You can cancel your Copilot plan at any time. The cancellation will take effect at the end of your current billing cycle. See [View And Change Your Copilot Plan](https://docs.github.com/en/copilot/how-tos/manage-your-account/view-and-change-your-copilot-plan).
...
* [Manage Your Account](https://docs.github.com/en/copilot/how-tos/manage-your-account)
