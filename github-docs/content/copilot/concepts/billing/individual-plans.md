...
* A monthly allowance of AI credits. See [GitHub AI Credits allowance by plan](/copilot/concepts/billing/usage-based-billing-for-individuals).
...
* Everything in Copilot Pro, and:
  ...
  * A higher monthly allowance of AI credits. See [GitHub AI Credits allowance by plan](/copilot/concepts/billing/usage-based-billing-for-individuals).
...
* Everything in Copilot Pro+, and:
   ...
   * Our highest available monthly allowance of AI credits. See [GitHub AI Credits allowance by plan](/copilot/concepts/billing/usage-based-billing-for-individuals).
...
|--------|----------------------------------------------------|----------------------------------------------|--------------------------------------------------|----------------------------------------------------------|----------------------------------------------------------|
| Price | Free | [Free](/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-students) | $10 USD per month<br>([free](/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-teachers-and-os-maintainers) for some users) | $39 USD per month | $100 USD per month  |
...
To learn how to set up the plan that’s right for you, see [Get Started With A Copilot Plan](https://docs.github.com/en/copilot/how-tos/manage-your-account/get-started-with-a-copilot-plan).
