...
This article gives an overview of the `/fleet` slash command. For details of how to use it, see [Speed Up Task Completion](https://docs.github.com/en/copilot/how-tos/copilot-cli/use-copilot-cli/speed-up-task-completion).
...
For more information about autopilot mode, see [Autopilot](https://docs.github.com/en/copilot/concepts/agents/copilot-cli/autopilot).
