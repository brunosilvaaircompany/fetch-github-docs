...
To see a complete reference of hook types with example use cases, best practices, and advanced patterns, see [Hooks Reference](https://docs.github.com/en/copilot/reference/hooks-reference).
...
* [Use Hooks](https://docs.github.com/en/copilot/how-tos/copilot-on-github/customize-copilot/customize-cloud-agent/use-hooks) for Copilot cloud agent
* [Use Hooks](https://docs.github.com/en/copilot/how-tos/copilot-cli/customize-copilot/use-hooks) for GitHub Copilot CLI
