...
When viewed, any _.csv_ or _.tsv_ file committed to a repository on GitHub automatically renders as an interactive table, complete with headers and row numbering. By default, we'll always assume the first row is your header row.
...
To display interactive maps, a site administrator must configure the feature for your GitHub Enterprise Server instance. For more information, see [Configuring Interactive Maps](https://docs.github.com/en/admin/configuring-settings/configuring-user-applications-for-your-enterprise/configuring-interactive-maps).
...
When you add Jupyter Notebook or IPython Notebook files with a _.ipynb_ extension on GitHub, they will render as static HTML files in your repository.

The interactive features of the notebook, such as custom JavaScript plots, will not work in your repository on GitHub. For an example, see [_Linking and Interactions.ipynb_](https://github.com/bokeh/bokeh-notebooks/blob/main/tutorial/06%20-%20Linking%20and%20Interactions.ipynb).
