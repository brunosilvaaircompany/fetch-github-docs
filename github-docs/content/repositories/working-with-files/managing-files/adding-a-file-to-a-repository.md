...
> [!TIP]
> You can also [add an existing file to a repository from the GitHub website](/repositories/working-with-files/managing-files/adding-a-file-to-a-repository).
