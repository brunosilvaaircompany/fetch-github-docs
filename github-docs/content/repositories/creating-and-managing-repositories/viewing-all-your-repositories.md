...
1. Under "Query", build your search query using the advanced filters. For help using filters, see [Searching For Repositories](https://docs.github.com/en/search-github/searching-on-github/searching-for-repositories).
