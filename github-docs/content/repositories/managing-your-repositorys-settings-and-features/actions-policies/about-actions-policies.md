...
To configure workflow execution protections for your repository, including setting up event and actor rules, see [Workflow Execution Protections](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/actions-policies/workflow-execution-protections).
