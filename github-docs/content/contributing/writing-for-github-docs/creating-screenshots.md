...
* Have alt text that describes the content of the image and the appearance of its highlighting, if any. For more information, see [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#alt-text).
...
* Show interfaces in light theme wherever possible.
  * For GitHub, select "Light default" in your appearance settings. For more information, see [Managing Your Theme Settings](https://docs.github.com/en/get-started/accessibility/managing-your-theme-settings).
