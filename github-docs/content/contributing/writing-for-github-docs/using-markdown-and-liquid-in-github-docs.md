...
GitHub Docs are written using Markdown, which is a human-friendly syntax for formatting plain text. We use the variant of Markdown called GitHub Flavored Markdown and ensure that it is compliant with CommonMark. For more information, see [About Writing And Formatting On GitHub](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/about-writing-and-formatting-on-github).
...
Alerts highlight important information that users need to know. For details about supported alert types, how to format them in Markdown, and information on when to use alerts, see [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#alerts).
...
Code annotations only work in articles with the `layout: inline` frontmatter property. For more information on how to write and style code annotations, see [Annotating Code Examples](https://docs.github.com/en/contributing/writing-for-github-docs/annotating-code-examples).
...
For an example of an article that uses code annotations on GitHub Docs, see [Publishing And Installing A Package With GitHub Actions](https://docs.github.com/en/packages/managing-github-packages-using-github-actions-workflows/publishing-and-installing-a-package-with-github-actions).
...
There are many examples of prompt blocks with context in the Copilot Cookbook. For example, see [Improve Code Readability](https://docs.github.com/en/free-pro-team@latest/copilot/tutorials/copilot-cookbook/refactor-code/improve-code-readability).
...
You can define a default platform in an article's YAML frontmatter. For more information, see [Using Yaml Frontmatter](https://docs.github.com/en/contributing/writing-for-github-docs/using-yaml-frontmatter#defaultplatform).
...
On rare occasions, we will add new tools. Before adding a new tool, read [Creating Tool Switchers In Articles](https://docs.github.com/en/contributing/writing-for-github-docs/creating-tool-switchers-in-articles). To add a new tool, add an entry to the `allTools` object in [`lib/all-tools.ts`](https://github.com/github/docs/blob/main/src/tools/lib/all-tools.ts) as a key-value pair. The key is the tag you'll use to refer to the tool in the article, and the value is how the tool will be identified on the tool picker at the top of the article.

You can define a default tool for an article in the YAML frontmatter. For more information, see [Using Yaml Frontmatter](https://docs.github.com/en/contributing/writing-for-github-docs/using-yaml-frontmatter#defaulttool).
...
For longer strings, we use reusables, and for shorter strings, we use variables. For more information about reusables and variables, see [Creating Reusable Content](https://docs.github.com/en/contributing/writing-for-github-docs/creating-reusable-content).
...
If you create a table where the first column contains headers for the table rows, wrap your table in the Liquid tag {% raw %}`{% rowheaders %} {% endrowheaders %}`{% endraw %}. For more information on using markup for tables, see [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#use-proper-markup-for-row-and-column-headers).
...
For a current example of this usage, see [Manage Your Work](https://docs.github.com/en/actions/tutorials/manage-your-work).
...
For more information about links, see [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#links).
...
* `For more information, see [Page](https://docs.github.com/en/path/to/page).`
* `For more information, see [Page](https://docs.github.com/en/path/to/page#section-link).`
* `For more information, see the TOOLNAME documentation in [Page?Tool=Toolname](https://docs.github.com/en/path/to/page?tool=TOOLNAME).`
