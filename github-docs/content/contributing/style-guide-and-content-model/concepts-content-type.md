...
For the conceptual content template, see [Templates](https://docs.github.com/en/contributing/writing-for-github-docs/templates#concepts-article-template).
...
* Conceptual sections within other articles
  * "About security policies" in [Creating A Default Community Health File](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/creating-a-default-community-health-file#about-security-policies)
  * "About maintenance mode" in [Enabling And Scheduling Maintenance Mode](https://docs.github.com/en/enterprise-server@latest/admin/administering-your-instance/configuring-maintenance-mode/enabling-and-scheduling-maintenance-mode#about-maintenance-mode)
