...
See the [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#permission-statements-and-product-callouts) for more information on formatting permission statements.
...
Conceptual content helps people understand or learn about a topic. For more information, see [Concepts Content Type](https://docs.github.com/en/contributing/style-guide-and-content-model/concepts-content-type) in the content model.

## Referential content

Referential content provides structured information related to actively using a product or feature. For more information, see [Reference Content Type](https://docs.github.com/en/contributing/style-guide-and-content-model/reference-content-type) in the content model.
...
* [Installing GitHub Enterprise Server On Aws](https://docs.github.com/en/enterprise-server@latest/admin/installing-your-enterprise-server/setting-up-a-github-enterprise-server-instance/installing-github-enterprise-server-on-aws)
* [Enabling Subdomain Isolation](https://docs.github.com/en/enterprise-server@latest/admin/configuring-settings/hardening-security-for-your-enterprise/enabling-subdomain-isolation)

## How-to content

How-to content helps people complete tasks. For more information, see [How To Content Type](https://docs.github.com/en/contributing/style-guide-and-content-model/how-to-content-type) in the content model.

## Troubleshooting content

Troubleshooting content helps people avoid or work through errors. For more information, see [Troubleshooting Content Type](https://docs.github.com/en/contributing/style-guide-and-content-model/troubleshooting-content-type) in the content model.
...
In this example from [Creating An Enterprise Account](https://docs.github.com/en/enterprise-cloud@latest/admin/managing-your-enterprise-account/creating-an-enterprise-account#next-steps), the next step links to where most people who just finished creating an enterprise account would want to go next.
...
Format further reading sections using unordered lists. See [Style Guide](https://docs.github.com/en/contributing/style-guide-and-content-model/style-guide#links) for how to write links.
