...
For the reference content template, see [Templates](https://docs.github.com/en/contributing/writing-for-github-docs/templates#reference-article-template).
...
* For subjects with a single element to explain, use a list.
  * Example: [Repository Roles For An Organization](https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/repository-roles-for-an-organization#repository-roles-for-organizations)
* For subjects with multiple elements to explain, use a table.
  * Example: [Repository Roles For An Organization](https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/repository-roles-for-an-organization#permissions-for-each-role)
* For longer referential content, such as YAML syntax for workflows, use headers consistently.
  ...
  * Example: [Workflow Syntax](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax)
...
* Reference articles
  ...
  * [Abilities Of Roles](https://docs.github.com/en/enterprise-cloud@latest/admin/managing-accounts-and-repositories/managing-roles-in-your-enterprise/abilities-of-roles)
  * [Billing](https://docs.github.com/en/rest/billing/billing) in the REST API documentation
  * [Reference](https://docs.github.com/en/graphql/reference) in the GraphQL API documentation
* Reference sections within other articles
  * "Supported languages" in [GitHub Mobile](https://docs.github.com/en/free-pro-team@latest/get-started/using-github/github-mobile#supported-languages-for-github-mobile)
  * "Hardware considerations" in [Installing GitHub Enterprise Server On Aws](https://docs.github.com/en/enterprise-server@latest/admin/installing-your-enterprise-server/setting-up-a-github-enterprise-server-instance/installing-github-enterprise-server-on-aws#hardware-considerations)
