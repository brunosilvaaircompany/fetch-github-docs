...
>[!NOTE] The github.dev editor is currently in public preview. You can provide feedback [in our Discussions](https://github.com/community/community/discussions/categories/codespaces). Additionally, the github.dev editor is not available on subdomains of GHE.com, such as `octocorp.ghe.com`.
...
|-|----------------|---------|
| **Cost** | Free.      | Free monthly quota of usage for personal accounts, see [GitHub Codespaces](https://docs.github.com/en/billing/concepts/product-billing/github-codespaces#free-and-billed-use-by-personal-accounts).|
