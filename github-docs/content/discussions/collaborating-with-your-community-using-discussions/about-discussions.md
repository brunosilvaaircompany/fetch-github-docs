...
Discussions are opened in user-defined categories, and can be further organized with repository labels. For more information about discussion management, see [Managing Discussions](https://docs.github.com/en/discussions/managing-discussions-for-your-community/managing-discussions).
...
If you're ready to try GitHub Discussions, get started at [Quickstart](https://docs.github.com/en/discussions/quickstart).
