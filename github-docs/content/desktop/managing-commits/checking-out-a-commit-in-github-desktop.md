...
1. To exit the "detached HEAD" state you will need to switch branches. For more information, see [Managing Branches In GitHub Desktop](https://docs.github.com/en/desktop/making-changes-in-a-branch/managing-branches-in-github-desktop#switching-between-branches).
