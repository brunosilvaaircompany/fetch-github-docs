...
You can find the node ID of a GitHub user or organization if you know the username. Replace <code>GITHUB_OWNER</code> with the GitHub username of the new project owner.
