...
1. Navigate to your project.
1. In your project, group a view by an iteration field. For more information, see [Customizing The Table Layout](https://docs.github.com/en/issues/planning-and-tracking-with-projects/customizing-views-in-your-project/customizing-the-table-layout#grouping-by-field-values).
