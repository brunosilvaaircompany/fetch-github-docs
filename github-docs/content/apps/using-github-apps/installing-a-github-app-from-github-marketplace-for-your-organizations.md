...
For enterprise managed user accounts, only enterprise owners can purchase and install a paid GitHub App for an organization in the enterprise. Enterprise members cannot purchase a paid GitHub App. Organization owners with an enterprise managed user account can still install a free GitHub App.
