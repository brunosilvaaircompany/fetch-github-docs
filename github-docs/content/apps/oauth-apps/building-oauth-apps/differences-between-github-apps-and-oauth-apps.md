...
> [!WARNING]
> Revoking all permission from an OAuth app deletes any SSH keys the application generated on behalf of the user, including [deploy keys](/authentication/connecting-to-github-with-ssh/managing-deploy-keys#deploy-keys).
...
> [!NOTE]
> GitHub Apps can also use a user-based token. For more information, see [Authenticating With A GitHub App On Behalf Of A User](https://docs.github.com/en/apps/creating-github-apps/authenticating-with-a-github-app/authenticating-with-a-github-app-on-behalf-of-a-user).
...
| GitHub Apps | OAuth apps |
| ----- | ----------- |
| GitHub App bots do not consume a GitHub Enterprise license. | A machine user account consumes a GitHub Enterprise license. |
