...
When creating an assignment, VS Code can be added as the preferred editor for an assignment. For more details, see [Integrate GitHub Classroom With An Ide](https://docs.github.com/en/education/manage-coursework-with-github-classroom/integrate-github-classroom-with-an-ide/integrate-github-classroom-with-an-ide).
