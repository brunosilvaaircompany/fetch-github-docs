...
* You’re familiar with making authenticated requests to the REST API. For an introduction, see [Using The Rest API](https://docs.github.com/en/rest/using-the-rest-api).
...
After you’ve decided which level to report on, use the REST API to retrieve usage data for paid GitHub products. For all endpoints, see [Usage](https://docs.github.com/en/rest/billing/usage).
...
For detailed examples and product-specific calculations, see [Introduction To Billing](https://docs.github.com/en/billing/get-started/introduction-to-billing).
