...
* GitHub Copilot uses models to perform its work, see [Copilot Requests](https://docs.github.com/en/copilot/reference/copilot-billing/request-based-billing-legacy/copilot-requests#model-multipliers)
* If you use models provided by other companies, see [Using Your Own API Keys In GitHub Models](https://docs.github.com/en/github-models/github-models-at-scale/using-your-own-api-keys-in-github-models)

## Multipliers and costs for direct use of GitHub Models

The table below lists the currently available models. Each model supported by GitHub Models has an input and output multiplier that determines the number of token units for each request. For more information on token units, see [GitHub Models](https://docs.github.com/en/billing/concepts/product-billing/github-models).
