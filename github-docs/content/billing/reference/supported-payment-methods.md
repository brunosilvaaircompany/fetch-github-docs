...
The following Azure subscription types cannot be used as a payment method for GitHub:
...
* GitHub Actions, see [GitHub Actions](https://docs.github.com/en/billing/concepts/product-billing/github-actions)
* GitHub Codespaces, see [GitHub Codespaces](https://docs.github.com/en/billing/concepts/product-billing/github-codespaces)
* GitHub Packages, see [GitHub Packages](https://docs.github.com/en/billing/concepts/product-billing/github-packages)
* Git Large File Storage, see [Git Lfs](https://docs.github.com/en/billing/concepts/product-billing/git-lfs)

In addition, usage-based billing is available for the following licenses:

* GitHub Enterprise, see [Billing For Enterprises](https://docs.github.com/en/billing/concepts/enterprise-billing/billing-for-enterprises)
* GitHub Copilot, see [GitHub Copilot Licenses](https://docs.github.com/en/billing/concepts/product-billing/github-copilot-licenses)
* GitHub Advanced Security, see [GitHub Advanced Security](https://docs.github.com/en/billing/concepts/product-billing/github-advanced-security)

For information about controlling spending, see [Set Up Budgets](https://docs.github.com/en/billing/how-tos/set-up-budgets).
