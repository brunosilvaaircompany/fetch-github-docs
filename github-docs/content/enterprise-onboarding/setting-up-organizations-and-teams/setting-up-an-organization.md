...
If you chose an enterprise with Enterprise Managed Users, it is not possible to invite an existing organization.
...
After you have created the organizations you need, learn how to manage people's access to your enterprise and organizations' settings and resources. See [About Roles In An Enterprise](https://docs.github.com/en/enterprise-onboarding/setting-up-organizations-and-teams/about-roles-in-an-enterprise).
